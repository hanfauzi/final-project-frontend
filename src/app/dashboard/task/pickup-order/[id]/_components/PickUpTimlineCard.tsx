          ...
          {pickUpOrder.arrivedAtOutlet && (
            <li className="mb-10 ml-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="font-semibold text-lg">Arrived At Outlet</div>
              </div>
            </li>
          )}
          {pickUpOrder.pickedUpAt && (
            <li className="mb-10 ml-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="font-semibold text-lg">Picked Up By Driver</div>
              </div>
            </li>
          )}
          {pickUpOrder.createdAt && (
            <li className="ml-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="font-semibold text-lg">Pick-up Order Requested</div>
              </div>
            </li>
          )}
        </ul>
