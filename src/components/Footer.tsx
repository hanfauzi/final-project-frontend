    ...
    >
      <div className="mx-auto w-full max-w-sm px-4 py-8 md:max-w-5xl md:px-6 md:py-10">
        ...
        <div className="mt-6 grid grid-cols-2 gap-6 md:mt-8 md:grid-cols-3 md:gap-8">
          <div>
            <h3 className="text-[15px] font-semibold text-foreground mb-2 md:text-base">Navigasi</h3>
          ...
          <div>
            <h3 className="text-[15px] font-semibold text-foreground mb-2 md:text-base">Kontak</h3>
